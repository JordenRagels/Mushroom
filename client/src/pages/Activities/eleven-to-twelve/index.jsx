...
class ElevenToTwelve extends Component {
    render() {
       ...
       <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcSNpEF7R0pMzXMOG36ZLlaabz0ga5xQWZEW01kk96b2EWWZYVM9' id="c-1-2-i" width="25%" height="10%" alt=" "></img>
                ...
                <div className="activites-for-eleven-to-twelve-months">
                    ...
                    <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTx1UZxfCAz_k2bdE_xC4pnY82d8T5oiEIfnmWBAQY8OoiATMVj' id="c-1-2-i2" width="25%" height="10%" alt=" "></img>
