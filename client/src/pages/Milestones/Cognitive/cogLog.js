    ...
    <div>
      ...
      <div className="card">
        ...
        <div className="btn-group">
          <button onClick={() => { setAState({ ...aState, accomlished: "Achieved", time: Date().toString() }); setZState({ ...zState, labels: ['blue'], datasets: [{ data: [1, 1] }] }); handleSubmit() }} className="btn-success"
          >
            Milestone Achieved!
          </button>
        </div>
