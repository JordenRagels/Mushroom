                    ...
                    <div id="calc_input">
                        ...
                        <div>
                            ...
                            <div className="medCalcFontOne"><input id="input128" type="radio"
                                className="Sex_radio" value="Female"
                                onChange={CDCInfantLengthForAge_fx} /> Female</div>


                            <div className="medCalcFontOne"><input id="input129" type="radio"
                                name="Sex_radio" value="Male"
                                onChange={CDCInfantLengthForAge_fx} /> Male</div>
