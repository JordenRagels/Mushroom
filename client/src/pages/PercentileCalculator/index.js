...
export default class Percentile extends Component {
    ...
    render() {
        ...
        function ZtoPercentile(z) {
            var b = (document.CDCInfantLengthForAge_form); {
                az = Math.abs(z);
        ...
        function CDCInfantLengthForAge_fx() {
            ...
            currenttimeout = window.self.setTimeout('minMaxCheck();', 3000);

            var c = (document.CDCInfantLengthForAge_form); {
                doCalc = true;
        ...
        function clrResults() {
            ...
            if (currenttimeout) window.self.clearTimeout(currenttimeout);

            var d = (document.CDCInfantLengthForAge_form); {

                Z_Score_param.value = 0;
                Percentile_param.value = 0;
